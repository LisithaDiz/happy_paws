...
.time-interval-container label {
    font-weight: bold;
}

.time-interval-container select {
    padding: 5px 10px;
    font-size: 1rem;
    border: 1px solid #ccc;
    border-radius: 5px;
...
.time-interval-container select:focus {
    border-color: #fae3e3; /* Highlight border on focus */
    box-shadow: 0 0 5px rgba(250, 227, 227, 0.8);
}
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <div class="time-interval-container">
                <label for="timeInterval">Select Time Slot Interval:</label>
                <select id="timeInterval" onchange="updateTimeSlots()">
